            ...
            <div className='flex mt-10 mb-20 gap-10 justify-center items-center'>
                ...
                <div className='w-2/5'>
                    ...
                    <div className="flex justify-between mt-5">
                        ...
                        <Link to={`/`}>
                            <div className="bg-[var(--bg-primary)] text-white font-bold py-3 px-5 rounded-xl flex items-center justify-center gap-2"><span>Take Assignment</span><FaArrowRight></FaArrowRight></div>
                        </Link>
                    </div>
                </div>
            </div>
