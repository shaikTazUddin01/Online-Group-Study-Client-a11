...
const GIveMark = () => {
    ...
    .then(res=>{
        ...
        toast.error("SuccessFully You Marking This Assignment")
    }
})
    ...
    return (
        ...
        <div className='min-w-[90vh] max-w-7xl mx-auto px-10'>
            ...
            <div className='flex flex-col mt-10 mb-20 gap-10 justify-center items-center w-3/5 mx-auto shadow-xl shadow-[var(--bg-primary)] rounded-xl'>
                {/* <div> */}
                <div className=''>
                ...
                <div className=''>
                    ...
                    <p className='text-lg'><span className=' text-2xl font-bold'>Pdf Link :</span> {pdfUrl}</p>
